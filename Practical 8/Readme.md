...
1. **Sandbox Setup**: Creates isolated `./sandbox` directory
2. **Package.json Creation**: Generates package.json with specific package version
3. **npm Install**: Uses npm CLI to install package and generate package-lock.json
4. **Tree Analysis**: Extracts deterministic dependency tree structure
5. **Checksum Generation**: Creates SHA256 hash of the package tree
6. **Verification**: Validates checksum consistency
